...
.method public final run()V
    ...
    invoke-static {v0}, Lcom/whatsapp/m/d;->b(Ljava/lang/String;)Lcom/whatsapp/m/e;

    move-result-object v4

    :try_start_0
    invoke-interface {v4}, Lcom/whatsapp/m/e;->a()V
    ...
    :goto_1
    :try_start_2
    sget-object v0, Lcom/whatsapp/m/e$b;->b:Lcom/whatsapp/m/e$b;

    invoke-interface {v4, v0, v2}, Lcom/whatsapp/m/e;->a(Lcom/whatsapp/m/e$b;I)V

    iget-object v0, p0, Lcom/whatsapp/registration/RegisterName$a;->c:Lcom/whatsapp/registration/RegisterName;

    invoke-static {v0}, Lcom/whatsapp/registration/RegisterName;->g(Lcom/whatsapp/registration/RegisterName;)Lcom/whatsapp/anq;
    ...
    :goto_2
    invoke-virtual {v5, v0}, Lcom/whatsapp/anq;->a(Z)V
    ...
    invoke-static {v2}, Lcom/whatsapp/registration/RegisterName;->h(Lcom/whatsapp/registration/RegisterName;)Lcom/whatsapp/anq;

    move-result-object v2

    invoke-virtual {v2}, Lcom/whatsapp/anq;->b()Z
    ...
    sget-object v0, Lcom/whatsapp/m/e$e;->j:Lcom/whatsapp/m/e$e;

    invoke-interface {v4, v0}, Lcom/whatsapp/m/e;->a(Lcom/whatsapp/m/e$e;)V
    ...
    invoke-static {v2}, Lcom/whatsapp/registration/RegisterName;->i(Lcom/whatsapp/registration/RegisterName;)Lcom/whatsapp/contact/sync/a;
    ...
    sget-object v2, Lcom/whatsapp/m/e$e;->j:Lcom/whatsapp/m/e$e;

    invoke-interface {v4, v2}, Lcom/whatsapp/m/e;->b(Lcom/whatsapp/m/e$e;)V
    ...
    invoke-interface {v4}, Lcom/whatsapp/m/e;->c()V
    :try_end_2
    ...
    :cond_5
    invoke-interface {v4}, Lcom/whatsapp/m/e;->b()V
    ...
    invoke-static {v0}, Lcom/whatsapp/registration/RegisterName;->m(Lcom/whatsapp/registration/RegisterName;)Lcom/whatsapp/anq;

    move-result-object v0

    const/4 v2, 0x1

    invoke-virtual {v0, v2}, Lcom/whatsapp/anq;->b(Z)V

    sget-object v0, Lcom/whatsapp/m/e$e;->k:Lcom/whatsapp/m/e$e;

    invoke-interface {v4, v0}, Lcom/whatsapp/m/e;->a(Lcom/whatsapp/m/e$e;)V

    iget-object v0, p0, Lcom/whatsapp/registration/RegisterName$a;->c:Lcom/whatsapp/registration/RegisterName;

    invoke-static {v0}, Lcom/whatsapp/registration/RegisterName;->n(Lcom/whatsapp/registration/RegisterName;)Lcom/whatsapp/messaging/p;
    ...
    invoke-static {v0}, Lcom/whatsapp/registration/RegisterName;->o(Lcom/whatsapp/registration/RegisterName;)Lcom/whatsapp/messaging/p;
    ...
    invoke-static {v0}, Lcom/whatsapp/registration/RegisterName;->q(Lcom/whatsapp/registration/RegisterName;)Lcom/whatsapp/ll;

    move-result-object v0

    iget-object v2, p0, Lcom/whatsapp/registration/RegisterName$a;->c:Lcom/whatsapp/registration/RegisterName;

    invoke-static {v2}, Lcom/whatsapp/registration/RegisterName;->p(Lcom/whatsapp/registration/RegisterName;)Lcom/whatsapp/d/c;

    move-result-object v2

    const/16 v5, 0x32

    invoke-virtual {v0, v2, v5}, Lcom/whatsapp/ll;->a(Lcom/whatsapp/d/c;I)Ljava/util/ArrayList;
    ...
    check-cast v0, Lcom/whatsapp/d/bd;

    sget-object v5, Lcom/whatsapp/App;->ah:Lcom/whatsapp/App;

    iget-object v0, v0, Lcom/whatsapp/d/bd;->t:Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/whatsapp/registration/RegisterName;->p(Lcom/whatsapp/registration/RegisterName;)Lcom/whatsapp/d/c;

    move-result-object v0

    invoke-virtual {v0}, Lcom/whatsapp/d/c;->d()Ljava/util/ArrayList;
    ...
    sget-object v2, Lcom/whatsapp/m/e$b;->c:Lcom/whatsapp/m/e$b;

    invoke-virtual {v0}, Ljava/util/ArrayList;->size()I

    move-result v5

    invoke-interface {v4, v2, v5}, Lcom/whatsapp/m/e;->a(Lcom/whatsapp/m/e$b;I)V
    ...
    iget-boolean v6, v0, Lcom/whatsapp/d/bd;->h:Z
    ...
    invoke-static {v0}, Lcom/whatsapp/registration/RegisterName;->a(Lcom/whatsapp/registration/RegisterName;)Lcom/whatsapp/d/bd;

    move-result-object v0

    iget v0, v0, Lcom/whatsapp/d/bd;->l:I
    ...
    invoke-static {v2}, Lcom/whatsapp/registration/RegisterName;->a(Lcom/whatsapp/registration/RegisterName;)Lcom/whatsapp/d/bd;

    move-result-object v2

    iget-object v2, v2, Lcom/whatsapp/d/bd;->t:Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/whatsapp/registration/RegisterName;->r(Lcom/whatsapp/registration/RegisterName;)Lcom/whatsapp/util/u;
    ...
    iget-object v0, v0, Lcom/whatsapp/App;->ag:Lcom/whatsapp/util/aw;

    const/4 v2, 0x1

    invoke-virtual {v0, v2}, Lcom/whatsapp/util/aw;->sendEmptyMessage(I)Z

    sget-object v0, Lcom/whatsapp/m/e$e;->k:Lcom/whatsapp/m/e$e;

    invoke-interface {v4, v0}, Lcom/whatsapp/m/e;->b(Lcom/whatsapp/m/e$e;)V
    ...
    invoke-static {v0}, Lcom/whatsapp/registration/RegisterName;->s(Lcom/whatsapp/registration/RegisterName;)Lcom/whatsapp/registration/ak;
